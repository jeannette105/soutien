...
import couture from "../Event social/3.jpg";
import coiffure from "../Event social/11.jpg";
import soy from "../Event social/66.jpg";
import you from "../Event social/77.jpg";
import yes from "../Event social/88.jpg";

const Offres = () => {
    return (
        <div>
            <div className='mt-35 px-4'>
                <h1 className='text-center text-3xl sm:text-5xl font-bold text-[#C0392B] '>Evènement Professionnel</h1>
                <p className='text-center text-base sm:text-xl mt-5'>
                    Chez Event Love, nous comprenons que chaque événement professionnel est une 
                    opportunité unique de renforcer les relations, de célébrer les succès et de 
                    promouvoir vos projets avec impact. Que vous organisiez une soirée d'entreprise, 
                    des retrouvailles entre collègues, un séminaire, une réunion d'entreprise, ou encore
                    un lancement et une promotion de produits, nous sommes là pour vous offrir une expérience 
                    sur mesure, parfaitement orchestrée et sans stress.
                </p>
                ...
                <div className='flex flex-col lg:flex-row gap-10 px-4'>
                    ...
                    <div>
                        <ul className="text-base sm:text-xl mt-10 list-disc ml-6">
                            <li className='p-2'>Soirée entre collègues</li>
                            <li className='p-2'>Séminaire d'entreprise</li>
                            <li className='p-2'>Promotions et lancement de produits</li>
            ...
            <div className='flex flex-wrap lg:flex-nowrap justify-center gap-4 sm:gap-6 mt-16 bg-amber-50 p-6 sm:p-10'>
                ...
                <div className='relative group shadow-2xl shadow-amber-500'>
                    <img src={soy} alt="Hôtellerie" className='w-full sm:w-80' />
                ...
                <div className='relative group shadow-2xl shadow-amber-400'>
                    <img src={you} alt="Restauration" className='w-full sm:w-80' />
                ...
                <div className='relative group shadow-2xl shadow-amber-500'>
                    <img src={yes} alt="Photographie" className='w-full sm:w-80' />
